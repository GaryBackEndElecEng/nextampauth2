...
const Articles = () => {
    ...
    React.useEffect(() => { setPage("/articles") }, [])
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center md:gap2 lg:gap-3">
                {
                    articles ? articles.map((article, index) => (
                        <div className="col-span-1 mx-auto p-2 shadow-lg shadow-blue-600 rounded-lg my-2" key={`${article.id}-${index}`}>
                            ...
                            <div className="flex flex-col m-auto items-center justify-center rounded-lg px-3 p-1 my-2 border shadow-md shadow-primarey-700 hover:shadow-blue-600 hover:tracking-widest">
