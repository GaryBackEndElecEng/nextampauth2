...
const DataInput = ({ setGraphData, graphData, setSummary, summary, setName, name, setDatasetArr, datasetArr, dataset, setDataset, setLabels, labels }: dataInputType) => {
    ...
    return (
        ...
        <form action="" className="m-auto flex flex-col dark:bg-black dark:text-white items-center justify-center m-1 p-1 py-5 mt-0 w-full ">
            ...
            <fieldset className="w-full  mx-auto border border-white rounded-lg dark:bg-black dark:text-white bg-black text-black m-2 p-3 py-[1rem] border border-green flex flex-col items-center justify-center gap-2">
                <h5 className="text-white mb-5 text-xl leading-10 my-3 py-3">create your own graph</h5>
