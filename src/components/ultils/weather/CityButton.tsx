...
const CityButton = ({ obj, setLatLong, countryCode, setCity }: setSelectLatLongType) => {
  ...
  return (
    <button
      ref={buttonCityRef}
      className={butt ? " cursor-pointer border border-teal rounded-lg shadow-lg shadow-teal-600 px-2 shadow-lg shadow-teal-500 transition-all ease-in-out transform scale(1.1) bg-blue "
        :
