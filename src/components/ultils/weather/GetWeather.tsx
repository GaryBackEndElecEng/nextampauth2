                ...
                {results && !error ?
                    <div className="lg:container lg:mx-auto flex flex-col items-center justify-center">
                        <Grid container spacing={3} className="lg:container lg:mx-auto">
                            ...
                            <Grid item xs={12} className="rotateColor" >
                            ...
                            <Grid item xs={12} className="current flex flex-col justify-center items-center">
                                <Grid container spacing={{ md: 1, xs: 3 }} className="lg:container lg:mx-auto p-2">
                                    <Grid item xs={12} >
